...
-- HIVE-22553 and CDPD-15627 (in cdw-master the upgrade scripts for these are in upgrade-3.1.2000-to-3.1.3000.hive.sql)
...
CREATE EXTERNAL TABLE IF NOT EXISTS `HIVE_LOCKS` (
...
SELECT 'Upgrading MetaStore schema to 3.1.3000.7.2.15.0-Update2';

USE SYS;

CREATE OR REPLACE VIEW `CDH_VERSION` AS SELECT 1 AS `VER_ID`, '3.1.3000.7.2.16.0-Update3' AS `SCHEMA_VERSION`,
  'Hive release version 3.1.3000 for CDH 7.2.16.0-Update3' AS `VERSION_COMMENT`;

SELECT 'Finished initializing schema to 3.1.3000.7.2.16.0-Update3';
