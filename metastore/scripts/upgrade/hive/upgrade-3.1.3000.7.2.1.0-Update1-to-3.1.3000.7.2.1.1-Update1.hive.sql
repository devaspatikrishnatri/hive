SELECT 'Upgrading MetaStore schema from 3.1.3000.7.2.1.0-Update1 to 3.1.3000.7.2.1.1-Update1';
...
CREATE OR REPLACE VIEW SYS.CDH_VERSION AS SELECT 1 AS VER_ID, '3.1.3000.7.2.1.1-Update1' AS SCHEMA_VERSION,
