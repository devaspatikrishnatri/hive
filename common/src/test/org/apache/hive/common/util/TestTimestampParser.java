...
public class TestTimestampParser {
  ...
  public void testDefault() {
    ...
    Assert.assertEquals(Timestamp.valueOf("2018-10-19 10:35:00.123"),
        tsp.parseTimestamp("2018-10-19 10:35:00.123 America/Los_Angeles"));
    Assert.assertEquals(Timestamp.valueOf("2018-10-19 10:35:00.123"),
        tsp.parseTimestamp("2018-10-19 10:35:00.123 GMT+01:00"));
    Assert.assertEquals(Timestamp.valueOf("2018-10-19 10:35:00.123"),
        tsp.parseTimestamp("2018-10-19 10:35:00.123+01:00"));
    Assert.assertEquals(Timestamp.valueOf("2018-10-19 10:35:00"),
        tsp.parseTimestamp("2018-10-19 10:35:00 America/Los_Angeles"));
    Assert.assertEquals(Timestamp.valueOf("2018-10-19 10:35:00"),
        tsp.parseTimestamp("2018-10-19 10:35:00 GMT+01:00"));
    Assert.assertEquals(Timestamp.valueOf("2018-10-19 10:35:00"),
