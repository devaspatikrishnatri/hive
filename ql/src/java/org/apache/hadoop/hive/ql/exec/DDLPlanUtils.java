...
public class DDLPlanUtils {
  ...
  public List<String> getDDLPlanForPartitionWithStats(Table table, Map<String, List<Partition>> tableToPartitionList)
    ...
    Map<String, List<ColumnStatisticsObj>> partitionColStats =
      Hive.get().getPartitionColumnStatistics(databaseName, tableName, partNames, columnNames, true);
