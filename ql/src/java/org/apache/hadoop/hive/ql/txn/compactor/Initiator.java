...
public class Initiator extends MetaStoreCompactorThread {
      ...
      do {
        ...
        try {
          ...
          Set<CompactionInfo> potentials = txnHandler.findPotentialCompactions(abortedThreshold,
              ...
              .stream()
              .filter(ci -> checkCompactionElig(ci, currentCompactions))
          ...
          if (!potentials.isEmpty()) {
            ValidTxnList validTxnList = TxnUtils.createValidReadTxnList(
  ...
  public void init(AtomicBoolean stop, AtomicBoolean looped) throws Exception {
    ...
    checkInterval = conf.getTimeVar(
        HiveConf.ConfVars.HIVE_COMPACTOR_CHECK_INTERVAL, TimeUnit.MILLISECONDS);
