...
public final class ParseUtils {
  ...
  /** Kept here despite HIVE-21843 to maintain compatibility with Spark (DO NOT USE INTERNALLY) **/
  public static ASTNode parse(String command) throws ParseException, IOException {
    return parse(command, new Context(new HiveConf()));
  }
  /** Parses the Hive query. */
