...
module StageType
  ...
  ATLAS_DUMP = 22
  ATLAS_LOAD = 23
  VALUE_MAP = {0 => "CONDITIONAL", 1 => "COPY", 2 => "DDL", 3 => "MAPRED", 4 => "EXPLAIN", 5 => "FETCH", 6 => "FUNC", 7 => "MAPREDLOCAL", 8 => "MOVE", 9 => "STATS", 10 => "DEPENDENCY_COLLECTION", 11 => "COLUMNSTATS", 12 => "REPL_DUMP", 13 => "REPL_BOOTSTRAP_LOAD", 14 => "REPL_STATE_LOG", 15 => "REPL_TXN", 16 => "REPL_INCREMENTAL_LOAD", 17 => "SCHEDULED_QUERY_MAINT", 18 => "ACK", 19 => "RANGER_DUMP", 20 => "RANGER_LOAD", 21 => "RANGER_DENY", 22 => "ATLAS_DUMP", 23 => "ATLAS_LOAD"}
  VALID_VALUES = Set.new([CONDITIONAL, COPY, DDL, MAPRED, EXPLAIN, FETCH, FUNC, MAPREDLOCAL, MOVE, STATS, DEPENDENCY_COLLECTION, COLUMNSTATS, REPL_DUMP, REPL_BOOTSTRAP_LOAD, REPL_STATE_LOG, REPL_TXN, REPL_INCREMENTAL_LOAD, SCHEDULED_QUERY_MAINT, ACK, RANGER_DUMP, RANGER_LOAD, RANGER_DENY, ATLAS_DUMP, ATLAS_LOAD]).freeze
end
