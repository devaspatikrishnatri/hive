...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class ShowLocksResponse implements org.apache.thrift.TBase<ShowLocksResponse, ShowLocksResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ShowLocksResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list746.size);
                @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem747;
                for (int _i748 = 0; _i748 < _list746.size; ++_i748)
                {
                  _elem747 = new ShowLocksResponseElement();
                  _elem747.read(iprot);
                  struct.locks.add(_elem747);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ShowLocksResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.locks != null) {
        oprot.writeFieldBegin(LOCKS_FIELD_DESC);
        {
          ...
          for (ShowLocksResponseElement _iter749 : struct.locks)
          {
  ...
  private static class ShowLocksResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<ShowLocksResponse> {
      ...
      if (struct.isSetLocks()) {
        {
          ...
          for (ShowLocksResponseElement _iter750 : struct.locks)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ShowLocksResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list751 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list751.size);
          @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem752;
          for (int _i753 = 0; _i753 < _list751.size; ++_i753)
          {
            _elem752 = new ShowLocksResponseElement();
            _elem752.read(iprot);
            struct.locks.add(_elem752);
          }
        }
        struct.setLocksIsSet(true);
      }
