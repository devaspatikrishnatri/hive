...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class SchemaVersion implements org.apache.thrift.TBase<SchemaVersion, SchemaVersion._Fields>, java.io.Serializable, Cloneable, Comparable<SchemaVersion> {
  ...
  public int compareTo(SchemaVersion other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSchemaText()).compareTo(other.isSetSchemaText());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSchemaText()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFingerprint()).compareTo(other.isSetFingerprint());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFingerprint()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new java.util.ArrayList<FieldSchema>(_list1088.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem1089;
                for (int _i1090 = 0; _i1090 < _list1088.size; ++_i1090)
                {
                  _elem1089 = new FieldSchema();
                  _elem1089.read(iprot);
                  struct.cols.add(_elem1089);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchemaVersion struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter1091 : struct.cols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter1092 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new java.util.ArrayList<FieldSchema>(_list1093.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem1094;
          for (int _i1095 = 0; _i1095 < _list1093.size; ++_i1095)
          {
            _elem1094 = new FieldSchema();
            _elem1094.read(iprot);
            struct.cols.add(_elem1094);
          }
        }
        struct.setColsIsSet(true);
      }
