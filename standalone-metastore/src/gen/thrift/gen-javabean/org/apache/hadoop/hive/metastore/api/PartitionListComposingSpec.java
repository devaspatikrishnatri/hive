...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class PartitionListComposingSpec implements org.apache.thrift.TBase<PartitionListComposingSpec, PartitionListComposingSpec._Fields>, java.io.Serializable, Cloneable, Comparable<PartitionListComposingSpec> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PartitionListComposingSpecStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PartitionListComposingSpecTupleSchemeFactory();
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("PartitionListComposingSpec(");
    boolean first = true;
  ...
  private static class PartitionListComposingSpecStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PartitionListComposingSpecStandardScheme getScheme() {
      return new PartitionListComposingSpecStandardScheme();
    }
  }

  private static class PartitionListComposingSpecStandardScheme extends org.apache.thrift.scheme.StandardScheme<PartitionListComposingSpec> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<Partition>(_list300.size);
                @org.apache.thrift.annotation.Nullable Partition _elem301;
                for (int _i302 = 0; _i302 < _list300.size; ++_i302)
                {
                  _elem301 = new Partition();
                  _elem301.read(iprot);
                  struct.partitions.add(_elem301);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionListComposingSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitions != null) {
        oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
        {
          ...
          for (Partition _iter303 : struct.partitions)
          {
  ...
  private static class PartitionListComposingSpecTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PartitionListComposingSpecTupleScheme getScheme() {
      return new PartitionListComposingSpecTupleScheme();
    }
  }

  private static class PartitionListComposingSpecTupleScheme extends org.apache.thrift.scheme.TupleScheme<PartitionListComposingSpec> {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (Partition _iter304 : struct.partitions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<Partition>(_list305.size);
          @org.apache.thrift.annotation.Nullable Partition _elem306;
          for (int _i307 = 0; _i307 < _list305.size; ++_i307)
          {
            _elem306 = new Partition();
            _elem306.read(iprot);
            struct.partitions.add(_elem306);
          }
        }
        struct.setPartitionsIsSet(true);
      }
