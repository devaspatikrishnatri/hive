...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class AddPartitionsResult implements org.apache.thrift.TBase<AddPartitionsResult, AddPartitionsResult._Fields>, java.io.Serializable, Cloneable, Comparable<AddPartitionsResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<Partition>(_list506.size);
                @org.apache.thrift.annotation.Nullable Partition _elem507;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionColSchema = new java.util.ArrayList<FieldSchema>(_list509.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem510;
                for (int _i511 = 0; _i511 < _list509.size; ++_i511)
                {
                  _elem510 = new FieldSchema();
                  _elem510.read(iprot);
                  struct.partitionColSchema.add(_elem510);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (Partition _iter512 : struct.partitions)
            {
      ...
      if (struct.partitionColSchema != null) {
        if (struct.isSetPartitionColSchema()) {
          oprot.writeFieldBegin(PARTITION_COL_SCHEMA_FIELD_DESC);
          {
            ...
            for (FieldSchema _iter513 : struct.partitionColSchema)
            {
  ...
  private static class AddPartitionsResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<AddPartitionsResult> {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (Partition _iter514 : struct.partitions)
          {
      ...
      if (struct.isSetPartitionColSchema()) {
        {
          ...
          for (FieldSchema _iter515 : struct.partitionColSchema)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, AddPartitionsResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list516 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.partitions = new java.util.ArrayList<Partition>(_list516.size);
          @org.apache.thrift.annotation.Nullable Partition _elem517;
          for (int _i518 = 0; _i518 < _list516.size; ++_i518)
          {
            _elem517 = new Partition();
            _elem517.read(iprot);
            struct.partitions.add(_elem517);
          }
        }
        struct.setPartitionsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionColSchema = new java.util.ArrayList<FieldSchema>(_list519.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem520;
          for (int _i521 = 0; _i521 < _list519.size; ++_i521)
          {
            _elem520 = new FieldSchema();
            _elem520.read(iprot);
            struct.partitionColSchema.add(_elem520);
          }
        }
        struct.setPartitionColSchemaIsSet(true);
      }
