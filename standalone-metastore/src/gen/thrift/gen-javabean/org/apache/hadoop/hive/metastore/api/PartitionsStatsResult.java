            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.partStats = new java.util.HashMap<java.lang.String,java.util.List<ColumnStatisticsObj>>(2*_map464.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key465;
                @org.apache.thrift.annotation.Nullable java.util.List<ColumnStatisticsObj> _val466;
                for (int _i467 = 0; _i467 < _map464.size; ++_i467)
                {
                  _key465 = iprot.readString();
                  {
                    ...
                    _val466 = new java.util.ArrayList<ColumnStatisticsObj>(_list468.size);
                    @org.apache.thrift.annotation.Nullable ColumnStatisticsObj _elem469;
                    for (int _i470 = 0; _i470 < _list468.size; ++_i470)
                    {
                      _elem469 = new ColumnStatisticsObj();
                      _elem469.read(iprot);
                      _val466.add(_elem469);
                    }
                    iprot.readListEnd();
                  }
                  struct.partStats.put(_key465, _val466);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PartitionsStatsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.partStats != null) {
        oprot.writeFieldBegin(PART_STATS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<ColumnStatisticsObj>> _iter471 : struct.partStats.entrySet())
          {
            oprot.writeString(_iter471.getKey());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter471.getValue().size()));
              for (ColumnStatisticsObj _iter472 : _iter471.getValue())
              {
  ...
  private static class PartitionsStatsResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<PartitionsStatsResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PartitionsStatsResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.List<ColumnStatisticsObj>> _iter473 : struct.partStats.entrySet())
        {
          oprot.writeString(_iter473.getKey());
          {
            oprot.writeI32(_iter473.getValue().size());
            for (ColumnStatisticsObj _iter474 : _iter473.getValue())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PartitionsStatsResult struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map475 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST); 
        struct.partStats = new java.util.HashMap<java.lang.String,java.util.List<ColumnStatisticsObj>>(2*_map475.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key476;
        @org.apache.thrift.annotation.Nullable java.util.List<ColumnStatisticsObj> _val477;
        for (int _i478 = 0; _i478 < _map475.size; ++_i478)
        {
          _key476 = iprot.readString();
          {
            ...
            _val477 = new java.util.ArrayList<ColumnStatisticsObj>(_list479.size);
            @org.apache.thrift.annotation.Nullable ColumnStatisticsObj _elem480;
            for (int _i481 = 0; _i481 < _list479.size; ++_i481)
            {
              _elem480 = new ColumnStatisticsObj();
              _elem480.read(iprot);
              _val477.add(_elem480);
            }
          }
          struct.partStats.put(_key476, _val477);
        }
      }
      struct.setPartStatsIsSet(true);
