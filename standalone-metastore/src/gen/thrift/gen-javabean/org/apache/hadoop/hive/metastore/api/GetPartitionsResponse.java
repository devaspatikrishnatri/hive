...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsResponse implements org.apache.thrift.TBase<GetPartitionsResponse, GetPartitionsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsResponse> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GetPartitionsResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GetPartitionsResponseTupleSchemeFactory();

  private @org.apache.thrift.annotation.Nullable java.util.List<PartitionSpec> partitionSpec; // required
  ...
  public GetPartitionsResponse(
    java.util.List<PartitionSpec> partitionSpec)
  {
    this();
  ...
  public GetPartitionsResponse(GetPartitionsResponse other) {
    if (other.isSetPartitionSpec()) {
      java.util.List<PartitionSpec> __this__partitionSpec = new java.util.ArrayList<PartitionSpec>(other.partitionSpec.size());
  ...
  public void addToPartitionSpec(PartitionSpec elem) {
    if (this.partitionSpec == null) {
      this.partitionSpec = new java.util.ArrayList<PartitionSpec>();
    }
    this.partitionSpec.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<PartitionSpec> getPartitionSpec() {
    return this.partitionSpec;
  }

  public void setPartitionSpec(@org.apache.thrift.annotation.Nullable java.util.List<PartitionSpec> partitionSpec) {
    this.partitionSpec = partitionSpec;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PARTITION_SPEC:
      if (value == null) {
        ...
        setPartitionSpec((java.util.List<PartitionSpec>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    if (isSetPartitionSpec())
      hashCode = hashCode * 8191 + partitionSpec.hashCode();
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GetPartitionsResponse(");
    boolean first = true;
  ...
  private static class GetPartitionsResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetPartitionsResponseStandardScheme getScheme() {
      return new GetPartitionsResponseStandardScheme();
    }
  }

  private static class GetPartitionsResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetPartitionsResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionSpec = new java.util.ArrayList<PartitionSpec>(_list1226.size);
                @org.apache.thrift.annotation.Nullable PartitionSpec _elem1227;
                for (int _i1228 = 0; _i1228 < _list1226.size; ++_i1228)
                {
                  _elem1227 = new PartitionSpec();
                  _elem1227.read(iprot);
                  struct.partitionSpec.add(_elem1227);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPartitionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionSpec != null) {
        oprot.writeFieldBegin(PARTITION_SPEC_FIELD_DESC);
        {
          ...
          for (PartitionSpec _iter1229 : struct.partitionSpec)
          {
  ...
  private static class GetPartitionsResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GetPartitionsResponseTupleScheme getScheme() {
      return new GetPartitionsResponseTupleScheme();
    }
  }

  private static class GetPartitionsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetPartitionsResponse> {
      ...
      if (struct.isSetPartitionSpec()) {
        {
          ...
          for (PartitionSpec _iter1230 : struct.partitionSpec)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list1231 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.partitionSpec = new java.util.ArrayList<PartitionSpec>(_list1231.size);
          @org.apache.thrift.annotation.Nullable PartitionSpec _elem1232;
          for (int _i1233 = 0; _i1233 < _list1231.size; ++_i1233)
          {
            _elem1232 = new PartitionSpec();
            _elem1232.read(iprot);
            struct.partitionSpec.add(_elem1232);
          }
        }
        struct.setPartitionSpecIsSet(true);
      }
