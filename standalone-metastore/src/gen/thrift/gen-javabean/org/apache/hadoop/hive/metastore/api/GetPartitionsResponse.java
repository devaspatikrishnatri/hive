...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsResponse implements org.apache.thrift.TBase<GetPartitionsResponse, GetPartitionsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsResponse> {
  ...
  public int compareTo(GetPartitionsResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPartitionSpec()).compareTo(other.isSetPartitionSpec());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionSpec = new java.util.ArrayList<PartitionSpec>(_list1192.size);
                @org.apache.thrift.annotation.Nullable PartitionSpec _elem1193;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionSpec = new java.util.ArrayList<PartitionSpec>(_list1197.size);
          @org.apache.thrift.annotation.Nullable PartitionSpec _elem1198;
