...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetAllFunctionsResponse implements org.apache.thrift.TBase<GetAllFunctionsResponse, GetAllFunctionsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetAllFunctionsResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.functions = new java.util.ArrayList<Function>(_list952.size);
                @org.apache.thrift.annotation.Nullable Function _elem953;
                for (int _i954 = 0; _i954 < _list952.size; ++_i954)
                {
                  _elem953 = new Function();
                  _elem953.read(iprot);
                  struct.functions.add(_elem953);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.functions != null) {
        if (struct.isSetFunctions()) {
          oprot.writeFieldBegin(FUNCTIONS_FIELD_DESC);
          {
            ...
            for (Function _iter955 : struct.functions)
            {
  ...
  private static class GetAllFunctionsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetAllFunctionsResponse> {
      ...
      if (struct.isSetFunctions()) {
        {
          ...
          for (Function _iter956 : struct.functions)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetAllFunctionsResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list957 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.functions = new java.util.ArrayList<Function>(_list957.size);
          @org.apache.thrift.annotation.Nullable Function _elem958;
          for (int _i959 = 0; _i959 < _list957.size; ++_i959)
          {
            _elem958 = new Function();
            _elem958.read(iprot);
            struct.functions.add(_elem958);
          }
        }
        struct.setFunctionsIsSet(true);
      }
