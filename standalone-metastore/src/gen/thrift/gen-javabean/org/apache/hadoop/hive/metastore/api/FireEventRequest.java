...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class FireEventRequest implements org.apache.thrift.TBase<FireEventRequest, FireEventRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FireEventRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list868.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem869;
                for (int _i870 = 0; _i870 < _list868.size; ++_i870)
                {
                  _elem869 = iprot.readString();
                  struct.partitionVals.add(_elem869);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tblParams = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map871.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key872;
                @org.apache.thrift.annotation.Nullable java.lang.String _val873;
                for (int _i874 = 0; _i874 < _map871.size; ++_i874)
                {
                  _key872 = iprot.readString();
                  _val873 = iprot.readString();
                  struct.tblParams.put(_key872, _val873);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter875 : struct.partitionVals)
            {
      ...
      if (struct.tblParams != null) {
        if (struct.isSetTblParams()) {
          oprot.writeFieldBegin(TBL_PARAMS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter876 : struct.tblParams.entrySet())
            {
  ...
  private static class FireEventRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<FireEventRequest> {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (java.lang.String _iter877 : struct.partitionVals)
          {
      ...
      if (struct.isSetTblParams()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter878 : struct.tblParams.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, FireEventRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list879 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.partitionVals = new java.util.ArrayList<java.lang.String>(_list879.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem880;
          for (int _i881 = 0; _i881 < _list879.size; ++_i881)
          {
            _elem880 = iprot.readString();
            struct.partitionVals.add(_elem880);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map882 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.tblParams = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map882.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key883;
          @org.apache.thrift.annotation.Nullable java.lang.String _val884;
          for (int _i885 = 0; _i885 < _map882.size; ++_i885)
          {
            _key883 = iprot.readString();
            _val884 = iprot.readString();
            struct.tblParams.put(_key883, _val884);
          }
        }
        struct.setTblParamsIsSet(true);
      }
