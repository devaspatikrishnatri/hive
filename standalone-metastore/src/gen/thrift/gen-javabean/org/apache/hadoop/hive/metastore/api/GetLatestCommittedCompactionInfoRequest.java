...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetLatestCommittedCompactionInfoRequest implements org.apache.thrift.TBase<GetLatestCommittedCompactionInfoRequest, GetLatestCommittedCompactionInfoRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetLatestCommittedCompactionInfoRequest> {
  ...
  public int compareTo(GetLatestCommittedCompactionInfoRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLastCompactionId()).compareTo(other.isSetLastCompactionId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLastCompactionId()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionnames = new java.util.ArrayList<java.lang.String>(_list772.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem773;
                for (int _i774 = 0; _i774 < _list772.size; ++_i774)
                {
                  _elem773 = iprot.readString();
                  struct.partitionnames.add(_elem773);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionnames != null) {
        if (struct.isSetPartitionnames()) {
          oprot.writeFieldBegin(PARTITIONNAMES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter775 : struct.partitionnames)
            {
      ...
      if (struct.isSetPartitionnames()) {
        {
          ...
          for (java.lang.String _iter776 : struct.partitionnames)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partitionnames = new java.util.ArrayList<java.lang.String>(_list777.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem778;
          for (int _i779 = 0; _i779 < _list777.size; ++_i779)
          {
            _elem778 = iprot.readString();
            struct.partitionnames.add(_elem778);
          }
        }
        struct.setPartitionnamesIsSet(true);
      }
