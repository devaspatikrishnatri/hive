...
class FindNextCompactRequest:
  ...
  def validate(self):
    ...
    if self.workerVersion is None:
      raise TProtocol.TProtocolException(message='Required field workerVersion is unset!')
    return
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i827 in xrange(_size823):
            ...
            self.fieldList.append(_elem828)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
...
class GetOpenTxnsRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i1058 in xrange(_size1054):
            _elem1059 = iprot.readI32()
            self.excludeTxnTypes.append(_elem1059)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.excludeTxnTypes is not None:
      ...
      for iter1060 in self.excludeTxnTypes:
        oprot.writeI32(iter1060)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
