...
INSERT INTO CDH_VERSION (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '3.1.3000.7.2.1.1-Update1', 'Hive release version 3.1.3000 for 7.2.1.1-Update1');

SELECT 'Initialized metastore to 3.1.3000.7.2.1.1-Update1' AS Status from dual;
