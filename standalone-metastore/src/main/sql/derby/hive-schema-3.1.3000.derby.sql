...
-- -----------------------------------------------------------------
INSERT INTO "APP"."VERSION" (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '3.1.3000', 'Hive release version 3.1.3000');
...
-- Create tables for data connectors
...
INSERT INTO "APP"."CDH_VERSION" (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '3.1.3000.7.2.17.0-Update1', 'Hive release version 3.1.3000 for CDH 3.1.3000.7.2.17.0-Update1');
