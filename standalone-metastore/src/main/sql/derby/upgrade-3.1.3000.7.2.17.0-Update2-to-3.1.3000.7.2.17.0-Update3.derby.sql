-- Upgrade MetaStore schema from 3.1.3000.7.2.17.0-Update2-to-3.1.3000.7.2.17.0-Update3
...
UPDATE "APP".CDH_VERSION SET SCHEMA_VERSION='3.1.3000.7.2.17.0-Update3', VERSION_COMMENT='Hive release version 3.1.3000 for CDH 7.2.17.0-Update3' where VER_ID=1;
