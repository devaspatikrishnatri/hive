SELECT 'Upgrading MetaStore schema from 3.1.3000.7.2.17.0-Update2-to-3.1.3000.7.2.17.0-Update3' AS MESSAGE;
...
SELECT 'Finished upgrading MetaStore schema from 3.1.3000.7.2.17.0-Update2 to 3.1.3000.7.2.17.0-Update3' AS MESSAGE;
