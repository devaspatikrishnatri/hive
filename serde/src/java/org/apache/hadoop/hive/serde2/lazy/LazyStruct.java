...
public class LazyStruct extends LazyNonPrimitive<LazySimpleStructObjectInspector>
  ...
  // replacementDelimLength - introduced in this HDP backport only, as MultiDelimitSerDe is in contrib on this branch
  public void parseMultiDelimit(byte[] rawRow, byte[] fieldDelimit, int replacementDelimLength) {
    ...
    int diff = fieldDelimit.length - replacementDelimLength;
